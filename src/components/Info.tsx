  ...
  return (
    <div className='infoWrapper flex flex-1'>
        <div className="infoLeft flex-1 basis-1/2 p-10 h-[75vh]">
            ...
            <h3 className="titleItem flex-1 flex items-center justify-center text-blue-600 text-[30px] h-[50px]">Student</h3>
            <h3 className="titleItem flex-1 flex items-center justify-center text-blue-600 text-[30px] h-[50px]">Career Changer</h3>
            <h3 className="titleItem flex-1 flex items-center justify-center text-blue-600 text-[30px] h-[50px]">Nice Guy</h3>
            <h3 className="titleItem flex-1 flex items-center justify-center text-blue-600 text-[30px] h-[50px]">Nice Guy</h3>
            <h3 className="titleItem flex-1 flex items-center justify-center text-blue-600 text-[30px] h-[50px]">Nice Guy</h3>
            </div>
            </div>
